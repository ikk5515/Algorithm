...
### 입력 
 ...
 <p style="user-select: auto;">
	첫째 줄에 테스트 케이스의 개수 N이 주어진다. 다음 N개의 줄에는 3개의 정수 r, e, c가 주어진다. r은 광고를 하지 않았을 때 수익, e는 광고를 했을 때의 수익, c는 광고 비용이다. (-10<sup style="user-select: auto;">6</sup> ≤ r,e ≤ 10<sup style="user-select: auto;">6</sup>, 0 ≤ c ≤ 10<sup style="user-select: auto;">6</sup>)</p>
